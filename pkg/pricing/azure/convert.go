...
func GetRateCardForAzure(region string) *models.RateCard {
	azurePricingArray := getAzureRateCard(region)
	// if err == nil {
	fmt.Println("getRateCardforAzure", azurePricingArray)
...
func getPurserRateCard(region string, pricingArray []*Pricing) *models.RateCard {
	...
	fmt.Println("getPurserRateCard", pricingArray)
