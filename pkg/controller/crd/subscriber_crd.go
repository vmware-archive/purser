...
const (
	// SubscriberPlural plural form value
	SubscriberPlural string = "subscribers"
	// SubscriberGroup value
	SubscriberGroup string = "kuber.input"
	// SubscriberVersion value
	SubscriberVersion string = "v1"
	// SubscriberFullName value
...
// SubscriberGroupVersion creates a Rest client with the new CRD Schema.
...
// NewSubscriberClient returns an instance of subscriber REST client.
